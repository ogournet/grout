...
// End behavior
//
static int process_behav_end(struct rte_mbuf *m, struct srv6_localsid_data *sr_d,
			     struct ip6_sr_rthdr *sr, struct rte_ipv6_hdr *ip6)
{
...
// End.d* behaviors
//
static int process_behav_decap(struct rte_mbuf *m, struct ip6_sr_rthdr *sr, struct rte_ipv6_hdr *ip6,
