...
ip netns del $p0 2> /dev/null
ip netns del $p1 2> /dev/null
ip netns add $p0
ip netns add $p1
...
# (2)
#grcli add sr steer dest 0.0.0.0/0 next fd00:202::2
grcli add sr steer dest 192.168.0.0/16 next fd00:202::2
